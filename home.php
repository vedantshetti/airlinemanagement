    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end mb-4 page-title">
                <h3 class="text-white">Welcome to <?php echo isset($_SESSION['setting_name']) ? $_SESSION['setting_name'] : 'Default Name'; ?></h3>
                                ...
                                <div class="row form-group">
                                            ...
                                            if ($airport) {
                                                while ($row = $airport->fetch_assoc()): ?>
                                                    <option value="<?php echo $row['id'] ?>" <?php echo isset($departure_airport_id) && $departure_airport_id == $row['id'] ? "selected" : ''; ?>>
                                                        <?php echo $row['city'] . ", " . $row['airport_name']; ?>
                                                    </option>
                                                <?php endwhile; 
                                            } else {
                                                echo "Error: " . $conn->error; // Display error if any
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <select name="arrival_airport_id" id="arrival_airport_id" class="custom-select browser-default select2">
                                            <option value=""></option>
                                            <?php
                                            // Using the same query for arrival airports
                                            $airport = $conn->query("SELECT * FROM airport_list ORDER BY airport_name ASC");
                                            if ($airport) {
                                                while ($row = $airport->fetch_assoc()): ?>
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-2 text-center">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="onewway">One-way</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 text-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="trip" id="rtrip" value="2">
                                            <label class="form-check-label" for="rtrip">Round Trip</label>
                                        </div>
                                    </div>
            ...
            <div class="row no-gutters">
                ...
                while ($row = $cats->fetch_assoc()): ?>
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <img class="img-fluid" src="/assets/img/philips.jpg" alt=""/>
